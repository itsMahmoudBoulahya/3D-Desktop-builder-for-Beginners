...
import { Monitor, Keyboard, Mouse, Printer, Zap, Headphones, Mic, Speaker, Camera, Scan } from 'lucide-react';
...
const components = [
  ...
  { name: 'power-strip', type: 'power', info: 'Power Strip', icon: <Zap className="h-6 w-6" /> },
